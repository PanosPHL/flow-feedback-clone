  ...
  return (
    <>
      <button
        onClick={openSidebar}
        type="button"
        className={styles['openButton' + className] + ' btn btn-sm btn-black'}
      >
        <MDBIcon
          icon={className === 'Open' ? 'chevron-left' : 'chevron-right'}
        />
      </button>
      <a href="/">
        <div>
      ...
      <div className={styles.lowerContent}>
        <Link to="/flow/fetch">
          <div className={styles['createFlow' + className]}>
            <button
              type="button"
              className={
                styles['createFlowButton' + className] + ' btn btn-amber'
              }
            >
              <MDBIcon icon="plus" />
            </button>
        ...
        <Link to="/my-flows">
          <div className={styles['myFlows' + className]}>
            <button
              type="button"
              className={styles['myFlowsButton' + className] + ' btn btn-amber'}
            >
        ...
        <div className={styles['catContainer' + className]}>
          ...
          <Link to="/category/1">
            <div className={styles['lol' + className]}>
              <button
                type="button"
                className={styles['lolButton' + className] + ' btn btn-amber'}
              >
                <img
                  alt="League of Legends"
                  src="/images/lol-icon.png"
                  className={styles['lolIcon' + className]}
                />
              </button>
          ...
          <Link to="/category/2">
            <div className={styles['ssbm' + className]}>
              ...
              >
                <img
                  alt="Super Smash Bros. Melee"
                  src="/images/ssbm-logo.png"
                  className={styles['lolIcon' + className]}
                />
              </button>
              <span>Melee</span>
            ...
            <div className={styles['overwatch' + className]}>
              ...
              >
                <img
                  ...
                  className={styles['overwatchIcon' + className]}
                />
              </button>
              <span>Overwatch</span>
            </div>
            ...
            <div className={styles['csgo' + className]}>
              ...
              >
                <img
                  ...
                  className={styles['csgoIcon' + className]}
                />
              </button>
              <span>CS:GO</span>
            </div>
